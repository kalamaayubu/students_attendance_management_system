...
export default function StudentLayout({ children }) {
  ...
  return (
    <div className="bg-white h-screen flex flex-col relative overflow-hidden">
      ...
      <div className="flex gap-0 h-full pt-[70px] relative">
        ...
        <div className="relative flex-1 h-full">
          ...
          {/* Main Content */}
          <main className="relative flex-1 h-full bg-slate-200 bg-opacity-80 p-4 overflow-y-auto z-30 md:p-5 lg:p-6">
            {children}
          </main>
        </div>
      </div>
