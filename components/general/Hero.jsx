  ...
  return (
    <section className="hero_section flex flex-col lg:flex-row lg:justify-between m-auto mb-20 mt-16">
      ...
      <div className="flex flex-col items-center">
        <div>
          <div className="w-80 h-[450px] lg:w-80 rounded-lg transition-transform hover:rotate-12 transform-gpu -rotate-12 hover:scale-95 drop-shadow-[20px_50px_10px_rgba(0,0,0,0.7)] hover:drop-shadow-[-20px_50px_10px_rgba(0,0,0,0.7)] mt-3">
            <img
