  ...
  return (
    <>
      <ReusableDialog
        ...
        title={dialogMessage}
        trigger={
          <div className="p-4 mb-2 cursor-pointer bg-white max-w-72 rounded-lg shadow-md shadow-gray-400 hover:shadow-lg hover:shadow-gray-400 transition-all duration-300">
            <div className="mb-4">
